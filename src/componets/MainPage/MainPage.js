    ...
    render() {
        return (
            <div className="stories_block">
                <div className="story">
                    <h3>Star Wars: Episode 1 – The Phantom Menace</h3>
                ...
                <div className="story">
                    <h3>Star Wars: Episode 3 – Revenge of the Sith</h3>
                    <div className="story_text">
                        <span className="text">
                ...
                <div className="story">
                    <h3>Star Wars: Episode 4 – A New Hope</h3>
                    <div className="story_text">
                        <span className="text">
                ...
                <div className="story">
                    <h3>Star Wars: Episode 6 – Return of the Jedi</h3>
                    <div className="story_text">
                        <span className="text">
